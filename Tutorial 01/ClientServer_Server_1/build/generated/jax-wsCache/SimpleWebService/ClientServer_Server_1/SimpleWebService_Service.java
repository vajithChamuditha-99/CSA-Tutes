 ...
 * 
 */
@WebServiceClient(name = "SimpleWebService", targetNamespace = "http://Server/", wsdlLocation = "http://localhost:25926/ClintServer_WebApplication_1/SimpleWebService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:25926/ClintServer_WebApplication_1/SimpleWebService?wsdl");
